...
const XadminAboutHeaderSection = (props: {objData:any}) => {
    const {objData} = props;
    ...
    const saveUpdate = async () => {
        ...
        const response = await axiosInstance.post("/api/about-us/header", payload);
...
export default XadminAboutHeaderSection
