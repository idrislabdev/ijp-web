...
const XadminAboutProfileSection = (props: {objData:any}) => {
    const {objData} = props;
    ...
    const saveUpdate = async () => {
        ...
        const response = await axiosInstance.post("/api/about-us/profile", payload);
    ...
    return (
        <div className='flex flex-col gap-[10px]'>
            ...
            <div className='admin-about-us-profile-section'>
                <div className='profile-container'>
                    ...
                    <div className='desc-subcontainer'>
                        ...
                        <div className='desc-quote'>
                            <textarea value={quote} onChange={e => setQuote(e.target.value)} className='quote'/>
...
export default XadminAboutProfileSection
