...
const XadminBusinessUnitsSection = (props: {objData:any}) => {
    ...
    const saveUpdate = async () => {
        ...
        const response = await axiosInstance.post("/api/home/business-units", payload);
            ...
            <div className='admin-home-business-unit-section'>
                <div className='business-unit-container'>
                    <div className='title-subcontainer w-full'>
                        <input value={title} onChange={e => setTitle(e.target.value)} className='text-center bg-transparent !text-white !w-full'/>
                        <textarea value={subtitle} onChange={e => setSubTitle(e.target.value)} className='text-center bg-transparent !text-white !w-full max-h-[100px] min-h-[100px]'/>
                    </div>
                    <div className='business-unit-subcontainer'>
                        <div className='business-unit'>
                            ...
                            <div className='business-unit-desc w-full'>
                                ...
                                <textarea value={units[0].description} onChange={e => setUnits([...units, units[0].description = e.target.value])} className='text-center bg-transparent !text-white !w-full min-h-[130px] max-h-[130px]'/>
                            </div>
                        </div>
                        <div className='business-unit'>
                            <label>IJSA</label>
                            <div className='business-unit-desc w-full'>
                                ...
                                <textarea value={units[1].description} onChange={e => setUnits([...units, units[1].description = e.target.value])} className='text-center bg-transparent !text-white !w-full min-h-[130px] max-h-[130px]'/>
                            </div>
                        </div>
                    </div>
                </div>
