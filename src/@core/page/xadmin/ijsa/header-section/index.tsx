...
const XadminIJSAHeaderSection = (props: {objData:any}) => {
    const {objData} = props;
    ...
    const saveUpdate = async () => {
        ...
        const response = await axiosInstance.post("/api/business-units-ijsa/header", payload);
    ...
    return (
        <div className='flex flex-col gap-[10px]'>
            ...
            <div className='admin-ijsa-hero-section'>
...
export default XadminIJSAHeaderSection
