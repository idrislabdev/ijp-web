        ...
        <div className="sidebar-menu-top">
          <div className="sidebar-header">
            ...
            <div className="sidebar-header-action">
              <a onClick={(_) => closeSidebar()}>
                <TimesIcon color={"#838899"} />
              </a>
            </div>
          </div>
          <div className="sidebar-list">
            <ul>
              <li>
                <a onClick={(_) => goToLink("about-us")}>{menu[lang].about}</a>
              </li>
              <li>
                <a onClick={(_) => goToLink("business-units/ijp")}>
                  {menu[lang].business_units} (IJP)
                </a>
              </li>
              <li>
                <a onClick={(_) => goToLink("business-units/ijsa")}>
                  {menu[lang].business_units} (IJSA)
                </a>
              </li>
              {/* <li><a onClick={_ => goToLink('news')}>News</a></li> */}
              <li>
                <a onClick={(_) => goToLink("careers")}>{menu[lang].careers}</a>
              </li>
              <li>
                <a onClick={(_) => goToLink("contact-us")}>
